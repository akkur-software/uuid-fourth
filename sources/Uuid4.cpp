...
Uuid4::Uuid4(Uuid4&& other) noexcept : m_value(std::array<uint8_t, 16>())
{
    *this = std::move(other);
}

Uuid4& Uuid4::operator=(Uuid4&& other) noexcept
{
    if (this != &other)
    {
        m_value[0] = other.Value()[0];
        m_value[1] = other.Value()[1];
        m_value[2] = other.Value()[2];
        m_value[3] = other.Value()[3];
        m_value[4] = other.Value()[4];
        m_value[5] = other.Value()[5];
        m_value[6] = other.Value()[6];
        m_value[7] = other.Value()[7];
        m_value[8] = other.Value()[8];
        m_value[9] = other.Value()[9];
        m_value[10] = other.Value()[10];
        m_value[11] = other.Value()[11];
        m_value[12] = other.Value()[12];
        m_value[13] = other.Value()[13];
        m_value[14] = other.Value()[14];
        m_value[15] = other.Value()[15];
